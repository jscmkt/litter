...
- (void)layoutSubviews {
    ...
    self.label.frame = CGRectMake(self.jk_width / 2.0 - 30, self.jk_height / 2.0 - 40, 80, 40);
    self.indView.frame = CGRectMake(self.jk_width / 2.0 - 70, self.label.jk_top, 40, 40);
}
...
- (void)showLoadingView {
    [self showLoadingViewWithFrame:CGRectMake(0, 0, Main_Screen_Width, 44)];
}
...
- (void)showLoadingViewWithFrame:(CGRect)frame {
    if (!self.loadingView) {
        ...
        loadingView.jk_centerY = self.view.jk_centerY - 50;
